...
The client API is represented with the interface `link:../../jsdoc/module-vertx-jpa-js_entity_manager_provider-EntityManagerProvider.html[EntityManagerProvider]`.
